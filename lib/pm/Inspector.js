...
class Inspector extends Core.cls( "Core.abstract.Component" ) {
	...
	/**
	 * The file system adapter the Inspector will use for file system operations.
	 *
	...
	async getGlobalDirectory() {
		...
		return me.fileSystemAdapter.dir( globalPath );
	...
	async getModulesAt( location, opts = null ) {
		...
		if( _.isString( location ) ) {
			location = me.fileSystemAdapter.dir( location );
		}
